...
<?php echo $this->Form->create('PhysicalProfile'); ?>
	<fieldset>
		<legend><?php echo __('Edit Physical Profile'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PhysicalProfile.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PhysicalProfile.id'))); ?></li>
